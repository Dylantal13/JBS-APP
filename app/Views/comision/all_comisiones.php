...
<div class="container mt-5">
  ...
  <button style="margin-top:100px;" type="button" id="add_comision" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary float-right mt-50">Agregar Comisión</button>
</div>
