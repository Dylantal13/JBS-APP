...
<div class="container mt-5">
  <div class="mt-3">
     <table class="table table-bordered" id="datatable_registros">
       <thead>
          <tr>
             <th>Id</th>
             <th>nombre</th>
...
<a href="<?= site_url('/registros/crear')?>"><button style="margin-top:100px;" type="button" id="add_registro" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary float-right mt-50">Agregar Registro</button></a>
